...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += escapeExpression(stack1)
    + "</h4>\n                </div>\n                <div class=\"panel-body\">\n                    <p><img src=\"http://maps.googleapis.com/maps/api/staticmap?center=";
  ...
  buffer += escapeExpression(stack1)
    + "&zoom=13&size=258x90&markers=size:small%7C";
  if (helper = helpers.latitude) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.latitude); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + ",";
  ...
  buffer += escapeExpression(stack1)
    + "&style=feature:all%7Celement:all%7Chue:0x428bca%7Clightness:-10%7Csaturation:-60%7Cvisibility:simplified&sensor=false\"></p>                 \n                    <address>\n                    <strong>";
...
function program1(depth0,data) {
  ...
  buffer += escapeExpression(stack1)
    + "&zoom=13&size=80x80&markers=size:small%7C";
  if (helper = helpers.latitude) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.latitude); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + ",";
  ...
  buffer += escapeExpression(stack1)
    + "&style=feature:all%7Celement:all%7Chue:0x428bca%7Clightness:-10%7Csaturation:-60%7Cvisibility:simplified&sensor=false\">\n                </div>\n                <div class=\"col-xs-8\">\n                    <h5 class=\"list-group-item-heading\">";
  if (helper = helpers.firstName) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.firstName); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + " ";
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<div class=\"navbar navbar-inverse\">\n    <div class=\"container\">\n        <div class=\"row\">\n            <div class=\"col-xs-4\"><a id=\"back-button\" class=\"btn btn-default navbar-btn\" href=\"#\"><span class=\"glyphicon glyphicon-chevron-left\"></span></a></div>\n            <div class=\"col-xs-4 text-center\"><h4 class=\"navbar-text\">Appointment</h4></div>\n        </div>\n    </div>\n</div>\n<div class=\"container\">\n    <div class=\"row\">\n        <div class=\"col-xs-12 text-center\"><div id=\"additional\" class=\"dial\"></div></div>\n    </div>\n    <div class=\"row\">\n        <div class=\"col-xs-12\"><p class=\"text-center\">Scroll the dial to<br>increase the appointment duration</p></div>\n    </div>\n</div>\n<div class=\"navbar navbar-fixed-bottom\">\n    <div class=\"container\">\n        <a id=\"start\" class=\"btn btn-primary btn-lg btn-block navbar-btn\" href=\"#appointment/";
  if (helper = helpers.id) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.id); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "/progress\"><span class=\"glyphicon glyphicon-play\"> START</span></a>\n    </div>\n</div>\n";
...
},{"../templates/Alert.hbs":19,"backbone":6,"jquery":16,"underscore":17}],33:[function(require,module,exports){
"use strict";
